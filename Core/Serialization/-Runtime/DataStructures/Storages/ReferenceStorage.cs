...
namespace UnitySimplified
{
    public class ReferenceStorage : Storage<ReferenceStorage>
    {
        ...
        internal Dictionary<Type, ValueTuple<Dictionary<string, object>, Dictionary<object, string>>> WrappedReferences => _wrappedreferences;
        ...
        public bool Contains(SerializableReference reference)
        { return Contains(reference.PersistentIdentifier, Type.GetType(reference.TypeIndexerAsString)); }
        public bool Contains(string persistentID, Type typeIndexer)
        { return TryGetObject(persistentID, typeIndexer, out _); }
        ...
        public bool Contains(object obj, Type typeIndexer)
        { return TryGetIdentifier(obj, typeIndexer, out _); }
        ...
        public void Append(SerializableReference reference, object obj)
        {

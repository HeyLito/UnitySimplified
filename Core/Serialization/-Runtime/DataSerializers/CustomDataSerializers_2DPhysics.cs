...
namespace UnitySimplified.Serialization
{
    ...
    public sealed class Rigidbody2DSerializer : IConvertibleData
    {
        public void Serialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
            ...
            if (flags.HasFlag(SerializerFlags.SoftRuntimeVariables))
                fieldData[nameof(Rigidbody2D.velocity)] = obj.velocity;

            if (flags.HasFlag(SerializerFlags.DeepRuntimeVariables))
            {
        ...
        public void Deserialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
            ...
            if (flags.HasFlag(SerializerFlags.AssetReferences))
            {
                object sharedMaterial = typeof(PhysicsMaterial2D);
                if (DataSerializerUtility.DeserializeFieldAsset(nameof(Rigidbody2D.sharedMaterial), ref sharedMaterial, fieldData))
    ...
    public sealed class CircleCollider2DSerializer : IConvertibleData
    {
        public void Serialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
        ...
        public void Deserialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
            ...
            {
                object sharedMaterial = typeof(PhysicsMaterial2D);
                if (DataSerializerUtility.DeserializeFieldAsset(nameof(CircleCollider2D.sharedMaterial), ref sharedMaterial, fieldData))
                    obj.sharedMaterial = (PhysicsMaterial2D)sharedMaterial;
            }
    ...
    public sealed class BoxCollider2DSerializer : IConvertibleData
    {
        public void Serialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
        ...
        public void Deserialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
            ...
            {
                object sharedMaterial = typeof(PhysicsMaterial2D);
                if (DataSerializerUtility.DeserializeFieldAsset(nameof(BoxCollider2D.sharedMaterial), ref sharedMaterial, fieldData))
                    obj.sharedMaterial = (PhysicsMaterial2D)sharedMaterial;
            }
    ...
    public sealed class EdgeCollider2DSerializer : IConvertibleData
    {
        public void Serialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
        ...
        public void Deserialize(object instance, Dictionary<string, object> fieldData, SerializerFlags flags)
        {
            ...
            {
                object sharedMaterial = typeof(PhysicsMaterial2D);
                if (DataSerializerUtility.DeserializeFieldAsset(nameof(EdgeCollider2D.sharedMaterial), ref sharedMaterial, fieldData))
                    obj.sharedMaterial = (PhysicsMaterial2D)sharedMaterial;
            }

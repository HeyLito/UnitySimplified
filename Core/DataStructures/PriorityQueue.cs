...
namespace UnitySimplified
{
    ...
    public class PriorityQueue<TPriority, TElement> where TPriority : IComparable
    {
        ...
        public void Clear()
        {   _dictionary.Clear(); _count = 0;   }

        public IEnumerator<KeyValuePair<TPriority, Queue<TElement>>> GetEnumerator()
        {
            return ((IEnumerable<KeyValuePair<TPriority, Queue<TElement>>>)_dictionary).GetEnumerator();
        }

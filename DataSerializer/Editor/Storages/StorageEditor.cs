...
namespace UnitySimplifiedEditor.Serialization
{
    public class StorageEditor<T> : Editor where T : Storage<T>
    {
        ...
        protected virtual void OnEnable() => _box = _idStyle = _unityObjectStyle = _errorStyle = null;
        ...
        protected virtual void OnFieldClick<V>(V value) where V : UnityObject => Selection.activeObject = value;
    }
}

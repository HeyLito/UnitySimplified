...
namespace UnitySimplified.Serialization 
{
    public class SerializerStorage : Storage<SerializerStorage>
    {
        ...
        public void Clear() => serializerTypes.Clear();

        public void Store(Type type) => serializerTypes.Add(type.AssemblyQualifiedName);
        ...
        {
            Instance.Clear();
            foreach (var type in typeof(IDataSerializable).Assembly.GetTypes())
            {

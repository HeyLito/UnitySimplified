...
namespace UnitySimplified.Serialization 
{
    ...
    public class ReferenceData
    {
        ...
        /// </param>
        internal ReferenceData(Type typeIndexer)
        {
        ...
        public ReferenceData(object referenceObj, Type typeIndexer)
        {
            persistentIdentifier = Guid.NewGuid().ToString();
            typeIndexerAsString = typeIndexer.AssemblyQualifiedName;
        ...
        /// </param>
        /// <param name="typeIndexer"></param>
        public ReferenceData(string customIdentifier, Type typeIndexer)
        {
        ...
        public override string ToString() => $"{base.ToString()}({(string.IsNullOrEmpty(persistentIdentifier) ? "Empty Identifier" : persistentIdentifier)})";
    }
}